...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Bearing Observability Grammian lower bound in SLAM for a circular trajectory around any point %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% Setup

s=sym('s','real');%time variable
t_0=sym('t_0','real');%intial time 
phi_0=sym('phi_0','real');%initial angle
T=sym('T','real');%time window 
...
H=[-x_l(2); x_l(1) ];%simplified gradient of the observations
...
%% Saving the results
% savefile='Grammian_bearing_circle_any_centre.mat';
% save(savefile);
