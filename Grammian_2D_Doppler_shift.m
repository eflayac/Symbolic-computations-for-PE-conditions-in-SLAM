...
%%%%%%%%%%%%%%%%%%%%%%%% Doppler Shift Observability Grammian lower bound for a circular trajectory around any point %%%%%%%%%%%%%%%%%%%%%%%%
...
H=[-v(1)*(x_l(2))^2+v(2)*(x_l(1))*(x_l(2));
   -v(2)*(x_l(1))^2+v(1)*(x_l(1))*(x_l(2)) ];% Simplified gradient of the observations
...
% savefile='Grammian_Doppler_shift_circle_any_centre.mat';
% save(savefile);
